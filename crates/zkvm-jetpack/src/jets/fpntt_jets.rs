...
pub const DEG:u64 = 3; // field extension degree
...
pub fn felt_as_noun(stack: &mut NockStack, felt:Felt) -> Result<Noun, JetErr> {
    let res_big =
...
mod tests {
    ...
    fn test_frep_jet() {
        ...
        let res = felt_as_noun(&mut c.stack, felt_from_u64s(1,2,3)).expect("felt_as_noun");
        ...
        let res = felt_as_noun(&mut c.stack, felt_from_u64s(0x0224a7df634f6c4e, 0x0381361a8c60a9f2, 0x04eae365951ab75c)).expect("felt_as_noun");
        assert_jet(c, frep_jet, sam, res);
    }
}